...
export function FormAddImage({ closeModal }: FormAddImageProps): JSX.Element {
    ...
    image: {
      ...
      validate: {
        ...
        acceptedFormats: file =>
          new RegExp(/\.(jpeg|jpg|png|gif)$/i).test(file[0].name) ||
          'Só são aceitos arquivos PNG, JPEG e GIF',
      },
    },
    title: {
  ...
  const onSubmit = async ({
    ...
    try {
      ...
      mutation.mutate({ title, description, url: imageUrl });
